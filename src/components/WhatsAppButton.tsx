...
export default function WhatsAppButton() {
  return (
    ...
    >
      <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-30 group-hover:pl-4 group-hover:pr-1 transition-all duration-300 text-sm font-medium">
        Chat with us
      </span>
