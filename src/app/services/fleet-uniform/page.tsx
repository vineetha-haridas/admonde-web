...
export const metadata: Metadata = {
  title: "Fleet & Uniform Branding | Admonde",
  description:
    "Vehicle wraps, branded uniforms, promotional merchandise, and fleet graphics across the GCC — brand consistency on every surface.",
};
...
const features = [
  ...
  "Lanyard & ID Cards",
  "Promo T-Shirts & Caps",
  "Branded Bags & Merchandise",
  "Safety Vests & PPE Branding",
      ...
      <section className="px-3 sm:px-5 lg:px-8 pt-20 sm:pt-24 pb-3">
        <div className="max-w-7xl mx-auto bg-[#f0ede6] rounded-3xl px-8 sm:px-12 lg:px-16 py-14 sm:py-20">
          ...
          <p className="text-[#666666] text-[14px] leading-relaxed max-w-lg">
            Brand consistency on every surface — from vehicle wraps and fleet graphics to
            branded uniforms, lanyards, and promotional merchandise.
          </p>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-[1fr_1.15fr]">
              ...
              <div className="px-8 sm:px-12 lg:px-14 py-12 lg:py-14 border-b lg:border-b-0 lg:border-r border-[#E8E4DC] flex flex-col justify-center">
                ...
                <p className="text-[#555555] text-[14px] leading-relaxed mb-4">
                  Every vehicle in your fleet and every uniform on your team is a moving
                  advertisement for your brand. Our fleet and uniform branding service
                  ensures your brand is presented consistently and professionally —
                  wherever your team goes.
                </p>
                <p className="text-[#777777] text-[13px] leading-relaxed mb-8">
                  From precision vehicle wraps applied bumper-to-bumper, to fully branded
                  uniforms, promotional merchandise, and corporate gifting — we handle the
                  full scope of brand touchpoints beyond traditional media.
                </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
              <div>
                ...
                <p className="text-white/60 text-[13px] leading-relaxed mt-3 max-w-sm">
                  Tell us your fleet size and requirements — we&apos;ll bring your brand to
                  life.
                </p>
              </div>
