...
export const metadata: Metadata = {
  title: "POP / POS Displays | Admonde",
  description:
    "Custom retail display racks, back-lit signs, banners, and point-of-sale systems that drive sales across the GCC.",
};

const features = [
  "Retail Display Racks & Stands",
  "Back-Lit & Acrylic Signs",
  "Roll-up & Pop-up Banners",
  "3D Signs & Sandwich Boards",
  "Gondola Ends & Shelf Talkers",
  "Standees & Header Cards",
  "Danglers & Wobblers",
  "Floor Graphics",
];
...
export default function POPDisplaysPage() {
  return (
      ...
      <section className="px-3 sm:px-5 lg:px-8 pt-20 sm:pt-24 pb-3">
        <div className="max-w-7xl mx-auto bg-[#f0ede6] rounded-3xl px-8 sm:px-12 lg:px-16 py-14 sm:py-20">
          ...
          <p className="text-[#666666] text-[14px] leading-relaxed max-w-lg">
            Retail displays that drive sales — custom racks, back-lit signs, roll-up
            banners, and point-of-sale systems designed to convert.
          </p>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-[1fr_1.15fr]">
              ...
              <div className="px-8 sm:px-12 lg:px-14 py-12 lg:py-14 border-b lg:border-b-0 lg:border-r border-[#E8E4DC] flex flex-col justify-center">
                ...
                <p className="text-[#555555] text-[14px] leading-relaxed mb-4">
                  Point-of-purchase and point-of-sale materials are your last line of
                  communication before a buying decision. Our team creates powerful retail
                  displays — from custom fabricated racks and back-lit acrylic signs to
                  roll-up banners and floor graphics — that stop customers in their tracks.
                </p>
                <p className="text-[#777777] text-[13px] leading-relaxed mb-8">
                  We&apos;ve delivered POP campaigns for Samsung, Decathlon, Nike, and more
                  across major hypermarkets and retail chains throughout the GCC —
                  consistent quality, consistent impact.
                </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
              <div>
                ...
                <p className="text-white/60 text-[13px] leading-relaxed mt-3 max-w-sm">
                  Share your display requirements and we&apos;ll provide a tailored
                  proposal.
                </p>
              </div>
