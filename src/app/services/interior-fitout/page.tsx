...
export const metadata: Metadata = {
  title: "Store & Office Branding | Admonde",
  description:
    "Indoor and outdoor signage, interior wall graphics, 3D design, and full store branding solutions across the GCC.",
};
...
const features = [
  ...
  "3D Interior Design",
  "Window & Shop Branding",
  "Retail Shelf Branding",
  "Office Lobby Branding",
  "Furniture & Fixtures",
  "Shop Fascia & Banners",
];
...
const projects = [
  ...
  {
    title: "Bupa Arabia Office Fit-out",
...
export default function StoreOfficeBrandingPage() {
  return (
      ...
      <section className="px-3 sm:px-5 lg:px-8 pt-20 sm:pt-24 pb-3">
        <div className="max-w-7xl mx-auto bg-[#f0ede6] rounded-3xl px-8 sm:px-12 lg:px-16 py-14 sm:py-20">
          ...
          <p className="text-[#666666] text-[14px] leading-relaxed max-w-lg">
            Spaces that speak your brand&apos;s language — from retail signage and wall
            graphics to full store fit-outs and office interiors.
          </p>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-[1fr_1.15fr]">
              ...
              <div className="px-8 sm:px-12 lg:px-14 py-12 lg:py-14 border-b lg:border-b-0 lg:border-r border-[#E8E4DC] flex flex-col justify-center">
                ...
                <p className="text-[#555555] text-[14px] leading-relaxed mb-4">
                  Your physical environment is a powerful expression of your brand. Our
                  store and office branding team transforms retail spaces and corporate
                  environments into immersive brand experiences — from signage and wall
                  graphics to full interior design and fabrication.
                </p>
                <p className="text-[#777777] text-[13px] leading-relaxed mb-8">
                  We&apos;ve delivered branding rollouts for LG, Bupa Arabia, TCL, and many
                  more — across hypermarkets, retail outlets, and corporate offices
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
              <div>
                ...
                <p className="text-white/60 text-[13px] leading-relaxed mt-3 max-w-sm">
                  Share your requirements and we&apos;ll provide a detailed proposal within
                  48 hours.
                </p>
              </div>
